...
- [x] Pin all GitHub Actions workflow `uses:` entries to full 40-character immutable SHAs and add a policy check to prevent moving refs, including PyPI/TestPyPI trusted-publishing workflows.
